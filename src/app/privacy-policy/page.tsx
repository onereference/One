    ...
    <div className="bg-slate-900 text-white min-h-screen py-12 md:py-16">
      <div className="container mx-auto px-4 max-w-3xl">
        <article className="prose prose-invert prose-lg lg:prose-xl prose-headings:text-primary prose-a:text-primary hover:prose-a:text-primary/80">
          ...
          <p>OneReference ("us", "we", or "our") operates the OneReference website (the "Service"). This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data.</p>
          ...
          <ul>
            ...
            <li>Professional information relevant to references (e.g., job titles, company names, work history provided by you or your references)</li>
          </ul>
          ...
          <h2>Use of Data</h2>
          <p>OneReference uses the collected data for various purposes:</p>
          <ul>
            ...
            <li>To facilitate the reference checking process as requested by you or an agency user</li>
          </ul>
          ...
          <p>OneReference will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

          <h2>Disclosure Of Data</h2>
          <h3>Legal Requirements</h3>
          <p>OneReference may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
          <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of OneReference</li>
          ...
          <ul>
            <li>By email: privacy@onereference.com</li>
